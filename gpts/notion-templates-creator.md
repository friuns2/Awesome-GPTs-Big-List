...
1. **create-template:** This command allows you to create a Notion template. You can specify the type of template you want to create, such as a project management template or a personal diary template.

2. **suggest-design:** This command helps you generate design ideas for your Notion templates. You can provide details or preferences, and the app will suggest suitable designs.
