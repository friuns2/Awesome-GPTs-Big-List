...
| --- | --- |
| `generateScene` | This command allows you to generate scenes from the beloved TV series "Friends." You can request specific scenes from different seasons or characters, or ask for a random scene. |
