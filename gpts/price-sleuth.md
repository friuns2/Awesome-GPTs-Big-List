...
1. **Welcome message:** The ChatGPT App will greet you with a friendly message: "Hello! Need help evaluating a product deal? Just ask!"

2. **Prompt starters:** You can use these prompts to start a conversation with the app and get information about product deals. For example:
