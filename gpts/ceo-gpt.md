...
| --- | --- |
| `getWisdom` | This command allows you to access the wisdom and advice from business icons. It provides concise mentorship to startup CEOs. |
| `welcomeMessage` | This command displays a welcome message for the ChatGPT App. The current welcome message is "Welcome, how can I assist you today?" |
| `tools` | This command provides information about the tools available in the ChatGPT app. It lists the different tools available for use and their corresponding IDs, types, metadata, and settings. |
