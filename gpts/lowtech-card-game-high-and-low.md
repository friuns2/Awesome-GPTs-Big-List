...
3. **Track Points**: Use the command "Track points" to keep score during the game and track the points earned by each player.

4. **Cheer Players**: Use the command "Cheer players" to provide encouragement and support to the players during the game.
