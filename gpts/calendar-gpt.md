...
1. **List Available Actions**
   - Description: Lists all the currently available actions for the user.
   - Command: `List available actions`

2. **Run Action**
   - Description: Runs an available action using plain English instructions.
   - Command: `Run action`

3. **RunRequest**
   - Description: Provides instructions and optional parameters to run an action.
   - Command: `RunRequest`

4. **RunResponse**
   - Description: Provides a summary of the results given the action that was run.
   - Command: `RunResponse`
