...
1. **Prompt 1:** "I have a batch of images that I need to resize while keeping the aspect ratio. Can you help me with that?"
...
1. **Resize:** This command allows you to resize images while keeping the aspect ratio intact. You can specify the maximum width or height for the resized images.

2. **Crop:** With this command, you can crop images to remove unwanted portions. You can specify the region to be cropped, such as the coordinates of the top left and bottom right corners.

3. **Rotate:** Use this command to rotate images by a specified angle. For example, you can rotate images 90 degrees clockwise or counterclockwise.
