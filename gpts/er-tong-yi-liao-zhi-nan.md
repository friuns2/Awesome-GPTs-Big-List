...
1. **Guide on childhood illnesses**: Use this command to get a guide on common childhood illnesses, including their symptoms and recommended actions.

2. **Home remedies for fever**: Use this command to get a list of home remedies that can help reduce fever in children.

3. **Cleaning and caring for an infant's umbilical cord**: Use this command to learn how to properly clean and care for an infant's umbilical cord stump to prevent infection.
