[![兵马俑](https://files.oaiusercontent.com/file-Fp7Z72bADd6oeG77gkPtpxwB?se=2123-10-17T04%3A30%3A58Z&sp=r&sv=2021-08-06&sr=b&rscc=max-age%3D31536000%2C%20immutable&rscd=attachment%3B%20filename%3DWX20231110-122931.png&sig=/k7WSAUS2XmjLJimZoArwmclapwFLnvY42npG/m4aL0%3D)](https://chat.openai.com/g/g-EcxN3n0Cm-bing-ma-yong)
...
| --- | --- |
| `browser` | This tool provides access to a web browser, allowing you to search for information related to the Terracotta Warriors or any other topic. |
| `dalle` | This tool uses the DALL·E model to generate images based on text prompts. You can use it to visualize the Terracotta Warriors or create other types of images. |
| `python` | This tool allows you to run Python code, which can be useful for performing calculations or interacting with other APIs. |