...
2. **Scene suggestion:** You can provide a suggestion to start the scene by using a prompt like "Let's start a scene with my suggestion" or "Suggest a specific word for us to start."
