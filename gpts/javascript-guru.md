...
| --- | --- |
| `teachTopics` | This command allows the AI to show you the topics covered in the JavaScript Guru course. |
| `runJavaScript` | This command provides guidance on how to run JavaScript code. |
| `beginnerLevel` | This command offers resources and tips for beginners in JavaScript. |
| `advancedLevel` | This command provides advanced-level materials and guidance for JavaScript users. |
